...
if __name__ == '__main__':
    ...
    parser.add_argument("-mode", default='train', type=str, choices=['train', 'validate', 'test', 'test_text', 'lead', 'oracle'])
    ...
    parser.add_argument("-model", type=str, default="base") # base, histbert or large
